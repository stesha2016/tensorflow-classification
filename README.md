...
#### 引入了一种depthwise convolution的网络结构，将原本的convolution变成了两个结构。一个是depthwise convolution(b),一个是1x1 pointwise convolution(c)
...
#### 提出了两种参数width multiplier和resolution multiplier
